<?php 
$pageTitle='Plenary Speakers'; //THIS MUST BE SET FOR EACH PAGE
...
<div style="margin-top:5%; margin-bottom: 5%" class="flex-column">
	<!-- <div class="organizer-group-title" style="font-style:italic;margin-left: 4%;line-height: 30px;">Opportunities and Challenges in Integration of Renewable Generation in Electric Grids</div>
	<div class="flex flex-auto person-container">
		<div class="pic headshot round" style="background:url(images/plenary_speakers/khargonekar.png);background-size:100px 100px;"></div>
		<div class="info-container">
			<div class="name">Professor Pramod Khargonekar</div>
			<div class="role bold">Vice Chancellor for Research</div>
			<div class="affiliation">University of California, Irvine</div>
		</div>
	</div> -->
<!-- 	<p style="margin-left:4%">
	...
	<div class="organizer-group-title" style="font-style:italic;margin-left: 4%;line-height: 30px;">Connected and automated vehicle and powertrain control technologies to achieve unprecedented fuel economy gains</div>
	<div class="flex flex-auto person-container">
		<div class="pic headshot round" style="background:url(images/plenary_speakers/rizzoni.png);background-size:100px 100px;"></div>
		<div class="info-container">
			<div class="name">Professor Giorgio Rizzoni</div>
			<div class="role bold">Director, Center for Automotive Research</div>
...
<!-- 	<div class="spacer" style="height:30px"></div>
	...
	<div style="font-size: 30px;font-weight: bold; margin-left:4%;line-height: 40px">Keynote Address</div>
	<div style="font-size: 13px; margin-left:4%;line-height: 20px;margin-bottom:20px">IEEE Control Systems Society, 2016 Transition to Practice Award Recipient</div> -->

	<div class="organizer-group-title" style="font-style:italic;margin-left: 4%;line-height: 30px;">Accurately Initializing Real Time Clocks to Provide Synchronized Time in Sensor Networks</div>
	<div class="flex flex-auto person-container">
		<div class="pic headshot round" style="background:url(images/plenary_speakers/Omprakash-Gnawali.jpg);background-size:100px 100px;"></div>
		<div class="info-container">
			<div class="name">Professor Omprakash Gnawali</div>
			<div class="role bold">Assistant Professor</div>
			<div class="affiliation">University of Houston</div>
		</div>
	</div>	
	<p style="margin-left:4%">
		Omprakash Gnawali: Postdoc (Stanford University), Ph.D. (University of Southern California), Masters and Bachelors (Massachusetts Institute of Technology).
	</p>
